        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '100%', padding: '10px 0' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ color: 'black', fontSize: 20, fontFamily: 'Montserrat', fontWeight: '400', wordWrap: 'break-word' }}>Actividad: Tirolesa</div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ color: 'black', fontSize: 20, fontFamily: 'Montserrat', fontWeight: '400', wordWrap: 'break-word' }}>Fecha: 25/06/2025</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '100%', padding: '10px 0' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ color: 'black', fontSize: 20, fontFamily: 'Montserrat', fontWeight: '400', wordWrap: 'break-word' }}>Visitantes: 2</div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ color: 'black', fontSize: 20, fontFamily: 'Montserrat', fontWeight: '400', wordWrap: 'break-word' }}>Hora: 11:00 am</div>
            </div>
          </div>
          ...
          <div style={{ width: '100%', paddingTop: 15, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '5px 0', width: '100%', justifyContent: 'center' }}>
              ...
              <div style={{ color: 'black', fontSize: 18, fontFamily: 'Montserrat', fontWeight: '400', wordWrap: 'break-word' }}>Leopoldo Lorenzo</div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '5px 0', width: '100%', justifyContent: 'center' }}>
              <FiUser size={18} color="black" /> {/* Icono de usuario */}
              <div style={{ color: 'black', fontSize: 18, fontFamily: 'Montserrat', fontWeight: '400', wordWrap: 'break-word' }}>Francisco Saggiorato</div>
            </div>
          </div>
          ...
          <div style={{ width: '100%', paddingTop: 50, display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: 40 }}> {/* Aumenté aún más el paddingTop */}
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <div style={{ color: '#009ADA', fontSize: 16, fontFamily: 'Montserrat', fontWeight: '400', lineHeight: '23px', wordWrap: 'break-word' }}>Aceptar términos y condiciones</div>
            </div>
          </div>
